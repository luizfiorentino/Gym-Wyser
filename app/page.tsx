...
export default function Home() {
  ...
  const [exercises, setExercises] = useState([
    ...
    },
    {
      ...
      isSelected: false,
      exercises: [
        { name: "barbell overhead press", chosen: false },
        { name: "dumbbell shoulder press", chosen: false },
        { name: "Arnold press", chosen: false },
        { name: "push press", chosen: false },
        { name: "dumbbell lateral raise", chosen: false },
        { name: "cable lateral raise", chosen: false },
        { name: "machine lateral raise", chosen: false },
        { name: "bent-over dumbbell rear delt fly", chosen: false },
        { name: "face pulls", chosen: false },
        { name: "reverse pec deck", chosen: false },
        { name: "dumbbell front raise", chosen: false },
        { name: "cable front raise", chosen: false },
        { name: "upright row", chosen: false },
        { name: "dumbbell incline rear delt fly", chosen: false },
        { name: "landmine shoulder press", chosen: false },
      ],
    },
    {
      group: "legs",
